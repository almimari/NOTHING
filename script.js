...
// });
	...
	{
		var hex=dechex(r)+dechex(g)+dechex(b);
		$("#picker").append('<div id="'+hex+'" style="float:left;background-color:#'+hex+';width:0.06628129%;height:100%;" onMouseover="$(\'\').css(\'background-color\',\'#\'+$(this).attr(\'id\'));$(\'#hex\').html(\'#\'+$(this).attr(\'id\')+\'<br/>\');"></div>');
	}
